    ...
    OVS_REQUIRES(dev->mutex)
{
    ...
    /* TODO: need this to get XL710 get link all times!!
    * Temp quick and dirty workaround: On startup on DPDK 17.02. That version of DPDK is not officially supported yet by OVS 2.7
    */
